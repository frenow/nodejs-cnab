...
import { parseRemessaCnab, parseEventMessage } from './retorno';
...
export { generateRemessaCnab, parseRemessaCnab, BANK, helperGenerateRemessaCNAB240, helperGenerateRemessaCNAB400, parseEventMessage };
